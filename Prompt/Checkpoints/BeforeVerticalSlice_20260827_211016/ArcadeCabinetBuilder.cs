...
public class ArcadeCabinetBuilder
{
    ...
    private void Construct(Transform parent)
    {
        ...
        // Vidros Laterais (Acrílico Translúcido)
        Cubo("Vidro_Lateral_Esq", new Vector3(-2.55f, 0.5f, 0), new Vector3(0.04f, 4.95f, 4.95f), mVidroAcrilico, rootParedes);
        Cubo("Vidro_Lateral_Dir", new Vector3(2.55f, 0.5f, 0), new Vector3(0.04f, 4.95f, 4.95f), mVidroAcrilico, rootParedes);
